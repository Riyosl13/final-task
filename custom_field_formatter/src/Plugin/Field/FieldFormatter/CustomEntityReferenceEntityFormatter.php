 ...
 *
 * @FieldFormatter(
 *   id = "customentity_reference_entity_view",
 *   label = @Translation("Custom Rendered entity"),
 ...
 * )
 */
class CustomEntityReferenceEntityFormatter extends EntityReferenceEntityFormatter {
